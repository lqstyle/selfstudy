...
import com.example.demo1.es.repository.entity.EsPage;
...
public class ElasticsearchUtil {
   ...
   * @return
   */
  public static EsPage<Map<String, Object>> searchDataPage(String index, String type, int startPage, int pageSize, QueryBuilder query, String fields, String sortField, String highlightField) {
